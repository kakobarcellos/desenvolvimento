<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="index.aspx.cs" Inherits="AdminResearch.index" %>
                                                ...
                                                <div class="item">
                                                    <div class="item-head">
                                                        <div class="item-details">
                                                            ...
                                                            <a  class="item-name primary-link">Nick Larson</a>
                                                ...
                                                <div class="item">
                                                    <div class="item-head">
                                                        <div class="item-details">
                                                            ...
                                                            <a  class="item-name primary-link">Mark</a>
                                                ...
                                                <div class="item">
                                                    <div class="item-head">
                                                        <div class="item-details">
                                                            ...
                                                            <a class="item-name primary-link">Richard Stone</a>
                                                ...
                                                <div class="item">
                                                    <div class="item-head">
                                                        <div class="item-details">
                                                            ...
                                                            <a  class="item-name primary-link">Dan</a>
                                                ...
                                                <div class="item">
                                                    <div class="item-head">
                                                        <div class="item-details">
                                                            ...
                                                            <a  class="item-name primary-link">Larry</a>
                                        ...
                                        <div id="region_statistics_content" class="display-none">
                                            <div class="btn-toolbar margin-bottom-10">
                                                <div class="btn-group btn-group-circle" data-toggle="buttons">
                                                    <a class="btn grey-salsa btn-sm active">Users </a>
                                                    <a class="btn grey-salsa btn-sm">Orders </a>
                                                </div>
                                                <div class="btn-group pull-right">
                                                    <a class="btn btn-circle grey-salsa btn-sm dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">Select Region
